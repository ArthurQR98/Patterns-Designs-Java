...
public class PD_Command {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Visualizacion del catalogo tras " + "ejecutar la primera solicitud (Descuento 10%)");
        catalogo.visualiza();
        System.out.println();
        
        SolicitudRebaja solicitudRebaja2 = new SolicitudRebaja(10, 5, 0.5);
        catalogo.ejecutaSolicitudRebaja(solicitudRebaja2);
        System.out.println("Visualizacion del catalogo tras " + "ejecutar la segunda solicitud (Descuento 50%)");
        catalogo.visualiza();
        System.out.println();
        ...
        System.out.println("Visualizacion del catalogo tras " + "anular la segunda solicitud");
        catalogo.visualiza();
        System.out.println();
